TRANSLATION_DICT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "grid_hint": "Drag the plots by their title to reorder them; the ½ / ⅓ / 1 buttons set each plot's width.",
    ...
    "de": {
        ...
        "grid_hint": "Ziehe die Diagramme am Titel, um sie umzusortieren; die Knöpfe ½ / ⅓ / 1 setzen die Breite.",
