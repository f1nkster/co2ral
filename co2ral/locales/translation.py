TRANSLATION_DICT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "plot_columns": "Charts side by side",
        "plot_columns_description": "How many plots share a row on wide screens.",
    ...
    "de": {
        ...
        "plot_columns": "Diagramme nebeneinander",
        "plot_columns_description": "Wie viele Diagramme sich auf breiten Bildschirmen eine Zeile teilen.",
