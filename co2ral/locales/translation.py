TRANSLATION_DICT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "grid_hint": "Drag the plots by their title to rearrange them, or resize them at the bottom-right corner.",
    ...
    "de": {
        ...
        "grid_hint": "Ziehe die Diagramme am Titel, um sie neu anzuordnen, oder ändere unten rechts ihre Größe.",
        "grid_reset": "Anordnung zurücksetzen",
        "drag_here": "verschieben",
